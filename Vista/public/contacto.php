...
<div class="container py-5">
    <div class="row mb-5">
        <div class="col-md-8 col-xl-6 text-center mx-auto">
            <h2 class="fw-bold">Como contactarnos</h2>
        </div>
    </div>
        ...
        <div class="col-md-6 col-xl-4">
            <div>
                <form class="p-3 p-xl-4" method="post" data-bs-theme="light">
                    ...
                    <div class="mb-3"><textarea id="message-1" class="form-control" name="message" rows="6" placeholder="Mensaje"></textarea></div>
            ...
            <div class="d-flex flex-wrap flex-md-column justify-content-md-start align-items-md-start h-100">
                <div class="d-flex align-items-center p-3">
                    ...
                    <div class="px-2">
                        ...
                        <p class="text-muted mb-0">0299-123456789</p>
                    </div>
                </div>
                <div class="d-flex align-items-center p-3">
                    ...
                    <div class="px-2">
                        ...
                        <p class="text-muted mb-0">contacto@toys.com.ar</p>
                    </div>
                </div>
                <div class="d-flex align-items-center p-3">
                    ...
                    <div class="px-2">
                        ...
                        <p class="text-muted mb-0">Calle de ejemplo al 555</p>
                    </div>
                </div>
            </div>
        </div>
